...
// @ts-ignore
import type { AlbumVO } from '../models';
// @ts-ignore
import type { ImageVO } from '../models';
// @ts-ignore
import type { PageResult } from '../models';
// @ts-ignore
import type { PictureBedVO } from '../models';
// @ts-ignore
import type { ResultsVO } from '../models';
/**
...
export const PicturebedMuyinSiteV1alpha1PictureBedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        albums: async (page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, pictureBedId?: string, type?: string, albumId?: string, imageId?: string, keyword?: string, categories?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        deleteImage: async (page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, pictureBedId?: string, type?: string, albumId?: string, imageId?: string, keyword?: string, categories?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        images: async (page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, pictureBedId?: string, type?: string, albumId?: string, imageId?: string, keyword?: string, categories?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        uploadImage: async (page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, pictureBedId?: string, type?: string, albumId?: string, imageId?: string, keyword?: string, categories?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const PicturebedMuyinSiteV1alpha1PictureBedApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async albums(page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, pictureBedId?: string, type?: string, albumId?: string, imageId?: string, keyword?: string, categories?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AlbumVO>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.albums(page, size, labelSelector, fieldSelector, sort, pictureBedId, type, albumId, imageId, keyword, categories, options);
         ...
         * @throws {RequiredError}
         */
        async deleteImage(page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, pictureBedId?: string, type?: string, albumId?: string, imageId?: string, keyword?: string, categories?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<boolean>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteImage(page, size, labelSelector, fieldSelector, sort, pictureBedId, type, albumId, imageId, keyword, categories, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async images(page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, pictureBedId?: string, type?: string, albumId?: string, imageId?: string, keyword?: string, categories?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PageResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.images(page, size, labelSelector, fieldSelector, sort, pictureBedId, type, albumId, imageId, keyword, categories, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async uploadImage(page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, pictureBedId?: string, type?: string, albumId?: string, imageId?: string, keyword?: string, categories?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResultsVO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.uploadImage(page, size, labelSelector, fieldSelector, sort, pictureBedId, type, albumId, imageId, keyword, categories, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export class PicturebedMuyinSiteV1alpha1PictureBedApi extends BaseAPI {
    ...
    public albums(requestParameters: PicturebedMuyinSiteV1alpha1PictureBedApiAlbumsRequest = {}, options?: RawAxiosRequestConfig) {
        return PicturebedMuyinSiteV1alpha1PictureBedApiFp(this.configuration).albums(requestParameters.page, requestParameters.size, requestParameters.labelSelector, requestParameters.fieldSelector, requestParameters.sort, requestParameters.pictureBedId, requestParameters.type, requestParameters.albumId, requestParameters.imageId, requestParameters.keyword, requestParameters.categories, options).then((request) => request(this.axios, this.basePath));
    }
